  ...
  products: {
    ...
    'rank-bronze': {
      ...
      kitContents: [
        ...
        { text: '4 Armour', icon: 'images/kit-gold-armour.png' },
        { text: '400 Ammo', icon: 'images/kit-gold-ammo.png' },
      ],
    ...
    'rank-gold': {
      ...
      kitContents: [
        { text: '2 Special Carbine', icon: 'images/kit-gold-special-carbine.png' },
        { text: '1 CombatPDW', icon: 'images/kit-gold-combatpdw.png' },
    ...
    'rank-silver': {
      ...
      kitContents: [
        { text: '1 Bullpop Rifle', icon: 'images/kit-silver-bullpup.png' },
        { text: '1 Tec-9', icon: 'images/kit-silver-tec9.png' },
        { text: '1 SMG', icon: 'images/kit-silver-smg.png' },
        { text: '3 Pistol.50', icon: 'images/kit-gold-pistol50.png' },
        { text: '6 Armour', icon: 'images/kit-gold-armour.png' },
        { text: '600 Ammo', icon: 'images/kit-gold-ammo.png' },
